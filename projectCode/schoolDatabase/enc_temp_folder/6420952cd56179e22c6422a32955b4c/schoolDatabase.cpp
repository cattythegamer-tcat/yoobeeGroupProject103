    ...
    while (true) {
        ...
        case 1:
            for (int classIdx = 0; classIdx < classroomRecords.size(); classIdx++)
            {
                ...
                {
                    if (std::find(childrenInfo.begin(), childrenInfo.end(), classroomRecords[classIdx].students[studentIdx].name) != childrenInfo.end())
                    {
            ...
            break;
        // Change username/password (Together due to password salting)
        case 2:
            break;
        //  Name
        case 3:
